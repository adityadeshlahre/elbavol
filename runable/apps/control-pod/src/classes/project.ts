...
export const pushProjectInitializationToServingPod = async (projectId: string, producer: Producer) => {
    ...
    try {
        ...
        console.error(`Failed to produce PROJECT_INITIALIZED for project ${projectId}:`, error)
        return false
    }
}
